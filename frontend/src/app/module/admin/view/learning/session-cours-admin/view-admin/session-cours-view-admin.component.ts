...
export class SessionCoursViewAdminComponent extends AbstractViewController<SessionCoursDto, SessionCoursCriteria, SessionCoursService> implements OnInit {
    ...
    constructor(private sessionCoursService: SessionCoursService, private sectionService: SectionService, private categorieSectionService: CategorieSectionService, private salaryService: SalaryService, private coursService: CoursService, private profService: ProfService, private groupeEtudiantService: GroupeEtudiantService){
