...
export class FreeTrialDetailEditAdminComponent extends AbstractEditController<FreeTrialDetailDto, FreeTrialDetailCriteria, FreeTrialDetailService>   implements OnInit {
    ...
    constructor( private freeTrialDetailService: FreeTrialDetailService , private freeTrialService: FreeTrialService, private etudiantService: EtudiantService) {
