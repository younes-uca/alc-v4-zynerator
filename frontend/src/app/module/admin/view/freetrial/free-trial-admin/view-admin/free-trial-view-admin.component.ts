...
export class FreeTrialViewAdminComponent extends AbstractViewController<FreeTrialDto, FreeTrialCriteria, FreeTrialService> implements OnInit {
    ...
    constructor(private freeTrialService: FreeTrialService, private freeTrialStudentEmailTemplateService: FreeTrialStudentEmailTemplateService, private niveauEtudeService: NiveauEtudeService, private freeTrialDetailService: FreeTrialDetailService, private freeTrialTeacherEmailTemplateService: FreeTrialTeacherEmailTemplateService, private freeTrialConfigurationService: FreeTrialConfigurationService, private freeTrialTeacherWhatsTemplateService: FreeTrialTeacherWhatsTemplateService, private freeTrialStudentWhatsTemplateService: FreeTrialStudentWhatsTemplateService, private statutFreeTrialService: StatutFreeTrialService, private profService: ProfService, private etudiantService: EtudiantService){
