...
export class GroupeEtudiantViewAdminComponent extends AbstractViewController<GroupeEtudiantDto, GroupeEtudiantCriteria, GroupeEtudiantService> implements OnInit {
    ...
    constructor(private groupeEtudiantService: GroupeEtudiantService, private groupeEtudiantDetailService: GroupeEtudiantDetailService, private groupeEtudeService: GroupeEtudeService, private parcoursService: ParcoursService, private profService: ProfService, private etudiantService: EtudiantService){
