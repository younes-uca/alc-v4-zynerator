...
export class InscriptionCreateAdminComponent extends AbstractCreateController<InscriptionDto, InscriptionCriteria, InscriptionService>  implements OnInit {
    ...
    constructor( private inscriptionService: InscriptionService , private packStudentService: PackStudentService, private etatInscriptionService: EtatInscriptionService, private statutSocialService: StatutSocialService, private niveauEtudeService: NiveauEtudeService, private groupeEtudeService: GroupeEtudeService, private interetEtudiantService: InteretEtudiantService, private quizService: QuizService, private parcoursService: ParcoursService, private skillService: SkillService, private fonctionService: FonctionService, private etudiantService: EtudiantService) {
