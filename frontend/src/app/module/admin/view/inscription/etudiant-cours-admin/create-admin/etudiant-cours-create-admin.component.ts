...
export class EtudiantCoursCreateAdminComponent extends AbstractCreateController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService>  implements OnInit {
    ...
    constructor( private etudiantCoursService: EtudiantCoursService , private coursService: CoursService, private profService: ProfService, private etudiantService: EtudiantService) {
