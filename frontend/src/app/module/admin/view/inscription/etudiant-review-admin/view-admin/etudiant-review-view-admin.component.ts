...
export class EtudiantReviewViewAdminComponent extends AbstractViewController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService> implements OnInit {
    ...
    constructor(private etudiantReviewService: EtudiantReviewService, private coursService: CoursService, private profService: ProfService, private etudiantService: EtudiantService){
