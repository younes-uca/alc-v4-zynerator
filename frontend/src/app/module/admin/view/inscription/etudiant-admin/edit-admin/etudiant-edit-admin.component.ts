...
export class EtudiantEditAdminComponent extends AbstractEditController<EtudiantDto, EtudiantCriteria, EtudiantService>   implements OnInit {
    ...
    constructor( private etudiantService: EtudiantService , private packStudentService: PackStudentService, private statutSocialService: StatutSocialService, private teacherLocalityService: TeacherLocalityService, private groupeEtudeService: GroupeEtudeService, private quizService: QuizService, private interetEtudiantService: InteretEtudiantService, private parcoursService: ParcoursService, private langueService: LangueService, private fonctionService: FonctionService, private groupeEtudiantDetailService: GroupeEtudiantDetailService, private quizEtudiantService: QuizEtudiantService, private niveauEtudeService: NiveauEtudeService, private etatEtudiantScheduleService: EtatEtudiantScheduleService, private skillService: SkillService, private groupeEtudiantService: GroupeEtudiantService) {
