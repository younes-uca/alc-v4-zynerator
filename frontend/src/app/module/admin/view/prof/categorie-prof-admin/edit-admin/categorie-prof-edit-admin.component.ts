...
export class CategorieProfEditAdminComponent extends AbstractEditController<CategorieProfDto, CategorieProfCriteria, CategorieProfService>   implements OnInit {
    ...
    constructor( private categorieProfService: CategorieProfService , private typeTeacherService: TypeTeacherService, private parcoursService: ParcoursService, private profService: ProfService) {
