...
export class ProfViewAdminComponent extends AbstractViewController<ProfDto, ProfCriteria, ProfService> implements OnInit {
    ...
    constructor(private profService: ProfService, private classRoomService: ClassRoomService, private recommendTeacherService: RecommendTeacherService, private typeTeacherService: TypeTeacherService, private quizService: QuizService, private parcoursService: ParcoursService, private trancheHoraireProfService: TrancheHoraireProfService, private categorieProfService: CategorieProfService, private etudiantService: EtudiantService){
        super(profService);
    }
