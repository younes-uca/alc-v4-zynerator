...
export class QuestionCreateAdminComponent extends AbstractCreateController<QuestionDto, QuestionCriteria, QuestionService>  implements OnInit {
   ...
   private _validQuestionRef = true;
    ...
    constructor( private questionService: QuestionService , private typeDeQuestionService: TypeDeQuestionService, private homeWorkService: HomeWorkService, private etatReponseService: EtatReponseService, private quizService: QuizService, private reponseService: ReponseService) {
