...
export class ClassRoomEditAdminComponent extends AbstractEditController<ClassRoomDto, ClassRoomCriteria, ClassRoomService>   implements OnInit {
    ...
    constructor( private classRoomService: ClassRoomService , private quizClassRoomService: QuizClassRoomService, private etudiantClassRoomService: EtudiantClassRoomService, private quizService: QuizService, private profService: ProfService, private etudiantService: EtudiantService) {
