...
export class QuizEtudiantEditAdminComponent extends AbstractEditController<QuizEtudiantDto, QuizEtudiantCriteria, QuizEtudiantService>   implements OnInit {
    ...
    constructor( private quizEtudiantService: QuizEtudiantService , private quizService: QuizService, private reponseService: ReponseService, private questionService: QuestionService, private reponseEtudiantService: ReponseEtudiantService, private etudiantService: EtudiantService) {
