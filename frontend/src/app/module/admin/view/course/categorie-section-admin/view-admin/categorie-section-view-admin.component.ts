...
export class CategorieSectionViewAdminComponent extends AbstractViewController<CategorieSectionDto, CategorieSectionCriteria, CategorieSectionService> implements OnInit {
    ...
    constructor(private categorieSectionService: CategorieSectionService, private sectionService: SectionService, private sessionCoursService: SessionCoursService, private coursService: CoursService, private superCategorieSectionService: SuperCategorieSectionService){
