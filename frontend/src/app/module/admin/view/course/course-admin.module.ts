...
} from './categorie-section-admin/create-admin/categorie-section-create-admin.component';
import {
    CategorieSectionEditAdminComponent
} from './categorie-section-admin/edit-admin/categorie-section-edit-admin.component';
import {
    CategorieSectionViewAdminComponent
} from './categorie-section-admin/view-admin/categorie-section-view-admin.component';
import {
    CategorieSectionListAdminComponent
} from './categorie-section-admin/list-admin/categorie-section-list-admin.component';
...
} from './super-categorie-section-admin/create-admin/super-categorie-section-create-admin.component';
import {
    SuperCategorieSectionEditAdminComponent
} from './super-categorie-section-admin/edit-admin/super-categorie-section-edit-admin.component';
import {
    SuperCategorieSectionViewAdminComponent
} from './super-categorie-section-admin/view-admin/super-categorie-section-view-admin.component';
import {
    SuperCategorieSectionListAdminComponent
} from './super-categorie-section-admin/list-admin/super-categorie-section-list-admin.component';
...
} from './vocabulary-quiz-admin/create-admin/vocabulary-quiz-create-admin.component';
import {
    VocabularyQuizEditAdminComponent
} from './vocabulary-quiz-admin/edit-admin/vocabulary-quiz-edit-admin.component';
import {
    VocabularyQuizViewAdminComponent
} from './vocabulary-quiz-admin/view-admin/vocabulary-quiz-view-admin.component';
import {
    VocabularyQuizListAdminComponent
} from './vocabulary-quiz-admin/list-admin/vocabulary-quiz-list-admin.component';
...
} from './level-test-configuration-admin/create-admin/level-test-configuration-create-admin.component';
import {
    LevelTestConfigurationEditAdminComponent
} from './level-test-configuration-admin/edit-admin/level-test-configuration-edit-admin.component';
import {
    LevelTestConfigurationViewAdminComponent
} from './level-test-configuration-admin/view-admin/level-test-configuration-view-admin.component';
import {
    LevelTestConfigurationListAdminComponent
} from './level-test-configuration-admin/list-admin/level-test-configuration-list-admin.component';
