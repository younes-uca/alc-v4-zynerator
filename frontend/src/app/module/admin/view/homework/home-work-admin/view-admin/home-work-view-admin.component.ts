...
export class HomeWorkViewAdminComponent extends AbstractViewController<HomeWorkDto, HomeWorkCriteria, HomeWorkService> implements OnInit {
    ...
    constructor(private homeWorkService: HomeWorkService, private resultatHomeWorkService: ResultatHomeWorkService, private homeWorkQuestionService: HomeWorkQuestionService, private typeDeQuestionService: TypeDeQuestionService, private coursService: CoursService, private typeHomeWorkService: TypeHomeWorkService, private homeWorkEtudiantService: HomeWorkEtudiantService, private etudiantService: EtudiantService){
