...
export class HomeWorkQuestionViewAdminComponent extends AbstractViewController<HomeWorkQuestionDto, HomeWorkQuestionCriteria, HomeWorkQuestionService> implements OnInit {
    ...
    constructor(private homeWorkQuestionService: HomeWorkQuestionService, private typeDeQuestionService: TypeDeQuestionService, private homeWorkService: HomeWorkService, private etatReponseService: EtatReponseService, private howeWorkQSTReponseService: HoweWorkQSTReponseService){
