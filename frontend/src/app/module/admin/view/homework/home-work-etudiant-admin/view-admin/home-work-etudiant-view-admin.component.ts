...
export class HomeWorkEtudiantViewAdminComponent extends AbstractViewController<HomeWorkEtudiantDto, HomeWorkEtudiantCriteria, HomeWorkEtudiantService> implements OnInit {
    ...
    constructor(private homeWorkEtudiantService: HomeWorkEtudiantService, private resultatHomeWorkService: ResultatHomeWorkService, private homeWorkService: HomeWorkService, private homeWorkQuestionService: HomeWorkQuestionService, private howeWorkQSTReponseService: HoweWorkQSTReponseService, private reponseEtudiantHomeWorkService: ReponseEtudiantHomeWorkService, private etudiantService: EtudiantService){
